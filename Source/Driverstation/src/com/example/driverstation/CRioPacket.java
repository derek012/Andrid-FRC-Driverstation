...
public class CRioPacket
{
	...
	private byte int4(int i)	//Returns the low byte of a short.
	{
		return (byte)(i & 0xFF);
	}
	private byte int3(int i)	//Returns the high byte of a short.
	{
	...
	public void setTeam(byte byte1, byte byte2)	//Set the team number
	{
		int num = Integer.parseInt		 //Convert to string and concatenate, then convert
				(Byte.toString(byte1) + Byte.toString(byte2)); //back to int as a whole number.
